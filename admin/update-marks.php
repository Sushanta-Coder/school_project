...
if (isset($_POST['save_result'])) {
    ...
    if ($post_class_id <= 0 || $post_section_id <= 0 || $post_exam_name === '') {
        ...
        header('Location: update-marks.php?class_id=' . $post_class_id . '&section_id=' . $post_section_id . '&exam_name=' . urlencode($post_exam_name));
        exit;
    }
...
<div class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0 text-dark">Update Marks</h1>
      </div>
      <div class="col-sm-6">
