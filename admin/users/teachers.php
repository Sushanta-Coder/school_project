<?php if (isset($_GET['action'])) {
    ...
    $citizenship_number = isset($user['citizenship_number']) ? $user['citizenship_number'] : '';
    ...
    <div class="card">
        <div class="card-body" id="form-container">
            <?php if ($_GET['action'] == 'view') { ?>
                <?php include('../lib/teacher-profile.php'); ?>
            <?php } elseif ($_GET['action'] == 'add-new' || $_GET['action'] == 'edit') { ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Citizenship Number" name="citizenship_number" value="<?php echo $citizenship_number; ?>">
                                </div>
                            </div>
                            <!-- Address Fields -->
                            <div class="col-lg-12">
                        ...
                        <table class="table border-0">
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div class="mt-2">
                                        <img id="teacher-photo-preview" class="border <?php echo empty($photo) ? 'd-none' : ''; ?>" src="<?php echo !empty($photo) ? '../dist/uploads/teacher-docs/' . $photo : ''; ?>" width="40" height="40" alt="Teacher Photo">
                                    </div>
                                    <?php
                                    if (!empty($photo)) {
                            ...
                            <tr>
                                ...
                                <td><input type="file" name="documention[citizenship_card]"></td>
                            </tr>
                            <tr>
                                <th>Resume</th>
...
<script>
            ...
            jQuery.ajax({
                ...
                success: function(response) {
                    try {
                        ...
                        if (res.success) {
                            location.href = 'user-account.php?user=teacher';
                        } else {
                            alert(res.message ? res.message : 'Unable to save teacher details');
                        }
                    } catch (e) {
                        location.href = 'user-account.php?user=teacher';
                    }
    ...
    jQuery('input[name="documention[photo]"]').on('change', function() {
