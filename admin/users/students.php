...
if (isset($_GET['action'])) {
            ...
            <table class="table border-0">
              <tr>
                ...
                <td>
                  ...
                  <div class="mt-2">
                    <img id="student-photo-preview" class="border <?php echo empty($photo) ? 'd-none' : ''; ?>" src="<?php echo !empty($photo) ? '../dist/uploads/student-docs/' . $photo : ''; ?>" width="40" height="40" alt="Student Photo">
                  </div>
                  <?php
                  if (!empty($photo)) {
              ...
              <tr>
                ...
                <td>
                  ...
                  <?php
                  if (!empty($aadhar)) {
                    echo '<a href="../dist/uploads/student-docs/' . $aadhar . '" target="_blank">View</a>';
                  }
                  ?>
                </td>
              </tr>
  ...
  <?php else : 
    ...
    include('../lib/student-profile.php');
    endif; ?>
<?php  } else { ?>
  <!-- Info boxes -->
  <div class="card">
...
<script>
  ...
  jQuery('#student-registration').on('submit', function(e) {
    ...
    if (true) {
      ...
      jQuery.ajax({
        type: "post",
        url: "http://localhost/school_project/actions/student-registration.php",
        data: formdata,
        cache: false,
        contentType: false,
        processData: false,
        ...
        success: function(response) {
          ...
          // if (response.success == true) {
            location.href = 'http://localhost/school_project/admin/user-account.php?user=student';
          // }
        },
        complete: function() {
        //   jQuery('#loader').hide();
...
<div class="modal fade" id="user-import-modal" aria-hidden="true" style="display: none;">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <form action="http://localhost/school_project/actions/student-registration.php" method="post" enctype="multipart/form-data">
