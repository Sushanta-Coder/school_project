...
<?php
  if (isset($_REQUEST['delete_id'])) {
    ...
    $delete_query = mysqli_query($db_conn, "DELETE FROM posts WHERE id = $delete_id AND type = 'class'");
    if ($delete_query) {
      mysqli_query($db_conn, "DELETE FROM metadata WHERE item_id = $delete_id");
              ...
              <tbody>
                ...
                foreach ($classes as $class) { ?>
                  <tr>
                    ...
                    <td>
                      <a href="?delete_id=<?=$class->id?>" class="btn btn-danger btn-xs" onclick="return confirm('Are you sure you want to delete this class?')">
